...
public class DatabaseFSIT {
	...
	public DatabaseFS createFS(FSFEnvironment environment) throws Exception {
		return new DatabaseFS(GeneralDatabaseFSWithCredentialsIT.createConfig(), environment);
	}

	@BeforeEach
	public void beforeEveryTest() throws Exception {
		GeneralDatabaseFSWithCredentialsIT.dropFileTableIfExists(GeneralDatabaseFSWithCredentialsIT.createConfig());
	}
