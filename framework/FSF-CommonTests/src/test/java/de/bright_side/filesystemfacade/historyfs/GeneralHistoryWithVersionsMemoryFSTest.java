...
public class GeneralHistoryWithVersionsMemoryFSTest extends GeneralFSTest {
	private static final int MAX_NUMBER_OF_HISTORY_FILES = 10;


	@Override
	public FSFSystem createFS(FSFEnvironment environment) {
		return new HistoryFS(new MemoryFS(environment), true, MAX_NUMBER_OF_HISTORY_FILES, HistoryFS.DEFAULT_VERSION_DIR_NAME, HistoryFS.DEFAULT_HISTORY_DIR_NAME, environment);
	}
