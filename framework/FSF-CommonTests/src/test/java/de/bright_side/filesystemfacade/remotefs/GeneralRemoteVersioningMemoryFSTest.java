...
public class GeneralRemoteVersioningMemoryFSTest extends GeneralFSTest {
	...
	public String listDirInnerFS(FSFSystem fs) throws Exception {
		...
		FSFFile dir = innerFS.createByPath("");
		return dir.listDirAsString(LIST_DIR_FORMATTING_SIMPLE);
	}
