...
public class GeneralHistoryWithVersionsEncryptedMemoryFSTest extends GeneralFSTest {
	...
	public FSFSystem createFS(FSFEnvironment environment) throws Exception {
		...
		return new HistoryFS(encryptedFS, true, MAX_NUMBER_OF_HISTORY_FILES, HistoryFS.DEFAULT_VERSION_DIR_NAME, HistoryFS.DEFAULT_HISTORY_DIR_NAME, environment);
	}
	...
	public boolean isInnerFSEncrypted() throws Exception {
		//: the inner FS is not encrypted, but the FS inside(!) the inner FS
		return false;
	}
